...
const SignIn = ({ navigation }) => {
	...
	return (
		<KeyboardAwareScrollView contentContainerStyle={styles.container} enableOnAndroid={true} extraScrollHeight={80}>
			...
			<View style={styles.box}>
				...
				<View style={styles.inputContainer}>
					<View style={styles.textInput1}>
						...
						<TextInput color={'black'} placeholderTextColor={'#808782'} placeholder='Enter Password' secureTextEntry={!press} style={styles.inputText} />

						<TouchableOpacity style={styles.eyeBtn} onPress={() => setPress2(!press2)}>
							{
								press2 ? <Feather name={'eye-off'} size={18} color={'#8F8F8F'} /> :
				...
				<View style={styles.textInput1}>
					<MaterialIcons name={"lock-outline"} size={18} color={'#808782'} style={styles.user} />
					<TextInput color={'black'} placeholderTextColor={'#808782'} placeholder='Re-Enter Password' secureTextEntry={!press} style={styles.inputText} />
			...
			<View style={styles.footerLine}>
				<Image source={require('./assets/footerLine.png')} />
			</View>
